...
class ZKLib
{
    ...
    {
        return (new ZK\Attendance())->get($this,$date);
    }
     ...
     * @return array [uid, id, state, timestamp]
     */
    public function getAttendance_date($date1,$date2)
    {
        return (new ZK\Attendance())->get_date($this,$date1,$date2);
    }
    /**
     * Get attendance log
     *
     * @return array [uid, id, state, timestamp]
     */
    public function getAttendance_all()
    {
        return (new ZK\Attendance())->get_all($this);
    }
    /**
     * Get attendance log
     *
     * @return array [uid, id, state, timestamp]
     */
    public function getAttendance_new($date)
    {
        return (new ZK\Attendance())->get_new($this, $date);
    }
